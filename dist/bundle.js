...
var LoadType = /* @__PURE__ */ ((LoadType2) => {
  LoadType2[LoadType2["BASIC"] = 0] = "BASIC";
  LoadType2[LoadType2["CIRCUIT"] = 1] = "CIRCUIT";
  return LoadType2;
})(LoadType || {});
var Load = class {
  constructor(_loadType) {
  ...
  static FromJSON(json, load = new Load(0 /* BASIC */)) {
...
// src/circuit.ts
var CircuitType = /* @__PURE__ */ ((CircuitType2) => {
  CircuitType2[CircuitType2["NONE"] = 0] = "NONE";
  CircuitType2[CircuitType2["SERIES"] = 1] = "SERIES";
  CircuitType2[CircuitType2["PARALLEL"] = 2] = "PARALLEL";
  return CircuitType2;
})(CircuitType || {});
var Circuit = class extends Load {
  ...
  solve(isSolvingCircuit = false) {
    ...
    if (this.circuitType == 2 /* PARALLEL */) {
  ...
  static FromJSON(json, circuit = new Circuit(0 /* NONE */)) {
...
var UIComponent = class extends HTMLElement {
  constructor(target) {
    super();
    this.target = target;
    (0, import_jquery.default)(this).addClass(this.constructor.name);
  }
};
...
var LoadUI = class extends UIComponent {
  constructor(target) {
    super(target);
    this.target = target;
    (0, import_jquery2.default)("<span> V: </span>").addClass("voltage").appendTo(this);
    (0, import_jquery2.default)("<span> I: </span>").addClass("current").appendTo(this);
    (0, import_jquery2.default)("<span> R: </span>").addClass("resistance").appendTo(this);
    (0, import_jquery2.default)("<input></input>").attr("size", "").appendTo((0, import_jquery2.default)(this).find(".voltage,.current,.resistance"));
    (0, import_jquery2.default)(this).find(">span>input").on("change", (e) => {
      const t = e.target;
      target[(0, import_jquery2.default)(t).parent("span")[0].classList[0]] = parseFloat(t.value);
      target.solve();
      this.update();
    });
    this.update();
...
var CircuitUI = class extends LoadUI {
  constructor(target) {
    super(target);
    this.target = target;
  ...
  update() {
    super.update();
    (0, import_jquery3.default)(this).find(".circuitType").val(this.target.circuitType);
    (0, import_jquery3.default)(this).find(".loads>.LoadUI").each((i, ui) => {
